...
g1_comp = merge(group1, demogconf2013)
...
g2_comp = merge(group2, demogconf2015)
...
g3_comp = merge(group3, demogconf2015)
...
g4_comp = merge(group4, demogconf2015)
...
g5_comp = merge(group5, demogconf2015)
...
g6_comp = merge(group6, demogconf2013)
...
g7_comp = merge(group7, demogconf2017)
